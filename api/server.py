    ...
    def handle_albums(self):
        ...
        for r in rows:
            ...
            thumb_url = (
                ...
                if r["thumb_path"] else file_url
            )

            if thumb_url not in album["thumbs"] and len(album["thumbs"]) < 8:
                album["thumbs"].append(thumb_url)

            mtime = r["mtime"]
            if mtime and (album["last_mtime"] is None or mtime > album["last_mtime"]):
                album["last_mtime"] = mtime
